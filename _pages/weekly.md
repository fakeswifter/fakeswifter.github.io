...
<div class="weekly-index">
  ...
  <div class="weekly-sources" aria-label="周记数据来源">
    <div><span>01</span><strong>主页访问</strong><p>统计接入后自动总结</p></div>
    <div><span>02</span><strong>GitHub 使用</strong><p>提交、仓库与公开活动</p></div>
    <div><span>03</span><strong>新增 Star</strong><p>这一周发现的开源项目</p></div>
  </div>
  <section class="weekly-archive" aria-labelledby="archive-heading">
    <div class="section-head">
      <div>
        <p class="section-kicker">Archive</p>
        <h2 id="archive-heading">全部周记</h2>
      </div>
    </div>
